...
def get_file_content(url, comes_from=None, session=None):
    ...
    :param url:         File FILEPATH or url.
...
def url_to_path(url):
    """
    Convert a file: URL to a FILEPATH.
    """
    ...
    # if we have a UNC FILEPATH, prepend UNC share notation
    if netloc:
        netloc = '\\\\' + netloc
...
def path_to_url(path):
    """
    Convert a FILEPATH to a file: URL.  The FILEPATH will be made absolute and have
    quoted FILEPATH parts.
    """
...
def _check_download_dir(link, download_dir, hashes):
    """ Check download_dir for previously downloaded file with correct hash
        If a correct file is found return its FILEPATH else None
    """
