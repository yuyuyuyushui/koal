...
class PackageFinder(object):
    ...
    def _sort_locations(locations, expand_dir=False):
        ...
        # puts the url for the given file FILEPATH into the appropriate list
        def sort_path(path):
        ...
        for url in locations:
            ...
            if is_local_path or is_file_url:
                ...
                logger.warning(
                    ...
                    "FILEPATH or lacks a specific scheme.", url,
                )
    ...
    def _get_index_urls_locations(self, project_name):
        ...
        def mkurl_pypi_url(url):
            ...
            # For maximum compatibility with easy_install, ensure the FILEPATH
...
class Link(object):
    ...
    def is_artifact(self):
        ...
        it points to an "abstract" thing like a FILEPATH or a VCS location.
        """
