...
class LegacyMetadata(object):
    ...
    - *filepath*, the filepath to a metadata file
    ...
    def __init__(self, path=None, fileobj=None, mapping=None,
        ...
        if [path, fileobj, mapping].count(None) < 2:
            raise TypeError('filepath, fileobj and mapping are exclusive')
        self._fields = {}
        self.requires_files = []
...
#    dependencies = property(_get_dependencies, _set_dependencies)
    ...
    def read(self, filepath):
        """Read the metadata values from a file filepath."""
...
class Metadata(object):
    ...
    def write(self, path=None, fileobj=None, legacy=False, skip_unknown=True):
        if [path, fileobj].count(None) != 1:
            raise ValueError('Exactly one of filepath and fileobj is needed')
        self.validate()
        if legacy:
            if self._legacy:
